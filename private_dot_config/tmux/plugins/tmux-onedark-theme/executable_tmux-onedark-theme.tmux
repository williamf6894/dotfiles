...
set "status-left" "#[fg=$onedark_black,bg=$onedark_green,bold] #S ${status_widgets} #{prefix_highlight}#[fg=$onedark_green,bg=$onedark_black,nobold,nounderscore,noitalics]"
